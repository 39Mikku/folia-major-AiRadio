...
contextBridge.exposeInMainWorld('electron', {
    ...
    radioWebSearch: (query) => ipcRenderer.invoke('radio-web-search', query),
    radioWriteBrief: (systemPrompt, sourcePrompt) => ipcRenderer.invoke('radio-write-brief', systemPrompt, sourcePrompt),
    radioSynthesizeSpeech: (text) => ipcRenderer.invoke('radio-synthesize-speech', text),
    radioBriefProbe: () => ipcRenderer.invoke('radio-brief-probe'),
    radioBriefWriteDebug: (runId, fileName, content) => ipcRenderer.invoke('radio-brief-write-debug', runId, fileName, content),
