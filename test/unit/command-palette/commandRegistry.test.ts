...
const createContext = (overrides: CommandPaletteContextOverrides = {}): CommandPaletteContext => {
    const base: CommandPaletteContext = {
        ...
        settings: {
            ...
            radioBriefEnabled: false,
            toggleRadioBrief: vi.fn(),
            radioBriefPrefetchEnabled: true,
            toggleRadioBriefPrefetch: vi.fn(),
            radioBriefPrefetchCount: 2,
            setRadioBriefPrefetchCount: vi.fn(),
