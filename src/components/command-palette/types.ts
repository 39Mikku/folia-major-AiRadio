...
export type CommandPaletteSettingsContext = {
    ...
    radioBriefEnabled: boolean;
    toggleRadioBrief: () => void;
    radioBriefPrefetchEnabled: boolean;
    toggleRadioBriefPrefetch: () => void;
    radioBriefPrefetchCount: number;
    setRadioBriefPrefetchCount: (count: number) => void;
