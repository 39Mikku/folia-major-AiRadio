...
export const settingsCommands: CommandPaletteCommand[] = [
    ...
    createSettingsAnchorCommand(
        'radio-brief-toggle',
        'Radio brief',
        'Open radio brief settings: enable, prefetch, Tavily and MiniMax keys',
        ['dj brief', '口播', '电台口播', '口播设置'],
        'radioBrief',
        { platform: ['electron'] },
    ),
    createToggleCommand(
        'radio-brief-prefetch-toggle',
        'settings',
        'Radio brief prefetch',
        'Prepare briefs and TTS for upcoming play-queue songs',
        ['radio prefetch', 'pregenerate brief', '口播预生成'],
        context => context.settings.toggleRadioBriefPrefetch(),
        { platform: ['electron'] },
    ),
    createSettingsAnchorCommand(
        'radio-brief-prefetch-count',
        'Radio brief prefetch count',
        'Open radio brief settings to set how many upcoming songs to pre-generate',
        ['prefetch count', 'pregenerate count', '口播预生成数量'],
        'radioBrief',
        { platform: ['electron'] },
    ),
