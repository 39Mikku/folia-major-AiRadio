...
export const buildSettingsCommandContext = (
    ...
    const radioBrief = useRadioBriefSettingsStore.getState();
    ...
    return {
        ...
        radioBriefEnabled: radioBrief.enabled,
        toggleRadioBrief: () => useRadioBriefSettingsStore.getState().setEnabled(
            !useRadioBriefSettingsStore.getState().enabled,
        ),
        radioBriefPrefetchEnabled: radioBrief.prefetchEnabled,
        toggleRadioBriefPrefetch: () => useRadioBriefSettingsStore.getState().setPrefetchEnabled(
            !useRadioBriefSettingsStore.getState().prefetchEnabled,
        ),
        radioBriefPrefetchCount: radioBrief.prefetchCount,
        setRadioBriefPrefetchCount: radioBrief.setPrefetchCount,
