...
export interface ProviderCapabilities {
    ...
    /** Hot comments used by the radio-brief four-piece set. NetEase implements `/comment/hot`. */
    hotComments?: boolean;
}
...
export interface ProviderHotComment {
    content: string;
    likes: number;
}

export interface OnlineCommentsProvider {
    getHotComments(song: SongResult, limit: number): Promise<ProviderHotComment[]>;
}
...
export interface OnlineMusicProvider {
    ...
    comments?: OnlineCommentsProvider;
...
export type OmniHotComment = ProviderHotComment;
