...
export default {
  "notifications": {
    ...
    "radioBriefOn": "电台口播已开启",
    "radioBriefOff": "电台口播已关闭",
    "radioBriefPrefetchOn": "口播预生成已开启",
    "radioBriefPrefetchOff": "口播预生成已关闭",
    "radioBriefKeysSaved": "口播密钥已保存",
    "radioBriefKeysSaveFailed": "口播密钥保存失败",
  ...
  "status": {
    ...
    "radioBriefLyrics": "口播：正在读歌词…",
    "radioBriefComments": "口播：正在取热评…",
    "radioBriefWeb": "口播：正在查创作背景…",
    "radioBriefWriting": "口播撰写中…",
    "radioBriefTts": "口播：正在合成语音…",
    "radioBriefWaitingMix": "口播：等待混音开口点…",
    "radioBriefSpeaking": "口播中",
    "radioBriefDone": "本首口播已播完",
    "radioBriefFailed": "口播生成失败",
    "radioBriefMissingTavily": "请在口播设置中填写 Tavily 密钥",
    "radioBriefMissingMinimax": "请在口播设置中填写 MiniMax 密钥",
    "radioBriefNoComments": "热评不足，无法写口播",
    "radioBriefNoCommentsCapability": "当前歌曲没有热评接口，换网易云歌曲",
    "radioBriefNoLyrics": "歌词不足，无法写口播",
    "radioBriefNoWeb": "网搜没有可用结果",
    "radioBriefWebFailed": "网搜失败",
    "radioBriefTtsFailed": "语音合成失败",
    "radioBriefWriteFailed": "口播文案生成失败",
    "radioBriefNeedPlay": "先播放歌曲再生成口播",
    "radioBriefNoAudioGraph": "音频通道还没起来，等这首真正出声后再点一次生成",
    "radioBriefDesktopOnly": "口播合成只在桌面端可用",
    "radioBriefProbeOk": "口播连通性正常",
    "radioBriefProbeFailed": "口播连通性检测失败",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "radio-brief-toggle": { "title": "电台口播", "description": "打开电台口播设置：开关、预生成、Tavily 与 MiniMax 密钥" },
      "radio-brief-prefetch-toggle": { "title": "口播预生成", "description": "为播放队列后续歌曲预先准备口播文案和 TTS" },
      "radio-brief-prefetch-count": { "title": "口播预生成数量", "description": "打开口播设置，调整预先生成后续多少首" },
  ...
  "options": {
    ...
    "radioBriefSettings": "电台口播",
    "radioBriefEnable": "开启口播",
    "radioBriefEnableDesc": "按当前播放队列生成节目口播，开口对齐智能过渡结束后的段落起点，并用混音 duck 叠在音乐上。需要桌面端、智能过渡，以及网易云歌曲。",
    "radioBriefDesktopOnly": "口播合成只在桌面端可用。",
    "radioBriefPrefetch": "预生成后续歌曲",
    "radioBriefPrefetchDesc": "在当前曲播放时，预先跑完后面几首的歌词、热评、网搜、文案和 TTS。",
    "radioBriefPrefetchCount": "预生成首数",
    "radioBriefMix": "口播压乐",
    "radioBriefVoiceLevel": "口播音量",
    "radioBriefDeveloper": "开发者模式",
    "radioBriefDeveloperDesc": "把每一步的仓鼠参数、材料、写稿请求体和 TTS 原文落到 userData/radio-brief-debug。",
    "radioBriefSystemPrompt": "口播提示词",
    "radioBriefSystemPromptDesc": "系统提示，默认来自节目口播技能原文。JSON 输出格式由后台自动拼接，不用写在这里。",
    "radioBriefSystemPromptReset": "恢复默认",
    "radioBriefDuckLevel": "口播时音乐音量",
    "radioBriefDuckRamp": "压下去的时间",
    "radioBriefUnduckRamp": "抬回来的时间",
    "radioBriefTavilyKey": "Tavily API Key",
    "radioBriefMinimaxKey": "MiniMax API Key",
    "radioBriefMinimaxVoice": "MiniMax 音色 ID",
    "radioBriefSaveKeys": "保存密钥",
    "radioBriefProbe": "检测连通性",
    "radioBriefProbeTavily": "网搜",
    "radioBriefProbeMinimax": "语音",
    "radioBriefProbeAi": "文案",
    "transitionEnable": "过渡",
    "transitionMode": "过渡模式",
    ...
    "playerControlSlotAction_radioBrief": "电台口播",
  ...
  "player": {
    "unknownArtist": "未知歌手",
    "unknownAlbum": "未知专辑",
    "radioBriefToggle": "电台口播",
    "radioBriefGenerate": "生成本首口播",
    "radioBriefRegenerate": "重新生成本首口播",
  },
  "localMusic": {
