...
export default {
  "notifications": {
    ...
    "radioBriefOn": "Radio brief is on",
    "radioBriefOff": "Radio brief is off",
    "radioBriefPrefetchOn": "Radio brief prefetch is on",
    "radioBriefPrefetchOff": "Radio brief prefetch is off",
    "radioBriefKeysSaved": "Radio brief keys saved",
    "radioBriefKeysSaveFailed": "Could not save radio brief keys",
  ...
  "status": {
    ...
    "radioBriefLyrics": "Radio brief: reading lyrics…",
    "radioBriefComments": "Radio brief: fetching comments…",
    "radioBriefWeb": "Radio brief: searching background…",
    "radioBriefWriting": "Writing radio brief…",
    "radioBriefTts": "Radio brief: synthesizing speech…",
    "radioBriefWaitingMix": "Radio brief: waiting for mix-in…",
    "radioBriefSpeaking": "On air",
    "radioBriefDone": "This brief finished",
    "radioBriefFailed": "Radio brief failed",
    "radioBriefMissingTavily": "Add a Tavily key in radio brief settings",
    "radioBriefMissingMinimax": "Add a MiniMax key in radio brief settings",
    "radioBriefNoComments": "Not enough hot comments to write a brief",
    "radioBriefNoCommentsCapability": "This song has no hot-comment API; use a NetEase track",
    "radioBriefNoLyrics": "Not enough lyrics to write a brief",
    "radioBriefNoWeb": "Web search returned nothing usable",
    "radioBriefWebFailed": "Web search failed",
    "radioBriefTtsFailed": "Speech synthesis failed",
    "radioBriefWriteFailed": "Brief writing failed",
    "radioBriefNeedPlay": "Play a song first",
    "radioBriefNoAudioGraph": "Audio graph is not ready; press play first",
    "radioBriefDesktopOnly": "Brief synthesis only runs on desktop",
    "radioBriefProbeOk": "Radio brief connectivity is OK",
    "radioBriefProbeFailed": "Radio brief connectivity check failed",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "radio-brief-toggle": { "title": "Radio brief", "description": "Open radio brief settings: enable, prefetch, Tavily and MiniMax keys" },
      "radio-brief-prefetch-toggle": { "title": "Radio brief prefetch", "description": "Prepare briefs and TTS for upcoming play-queue songs" },
      "radio-brief-prefetch-count": { "title": "Radio brief prefetch count", "description": "Open radio brief settings to set how many upcoming songs to pre-generate" },
  ...
  "options": {
    ...
    "radioBriefSettings": "Radio brief",
    "radioBriefEnable": "Enable briefs",
    "radioBriefEnableDesc": "Generate programme briefs for the play queue, speak after the automix settle at the incoming section start, and duck the mix under TTS. Desktop only; needs Folia transitions and NetEase tracks.",
    "radioBriefDesktopOnly": "Brief synthesis only runs in the desktop app.",
    "radioBriefPrefetch": "Pre-generate upcoming songs",
    "radioBriefPrefetchDesc": "While the current track plays, finish lyrics, comments, web search, copy and TTS for the next songs.",
    "radioBriefPrefetchCount": "Songs to pre-generate",
    "radioBriefMix": "Brief ducking",
    "radioBriefVoiceLevel": "Brief volume",
    "radioBriefDeveloper": "Developer mode",
    "radioBriefDeveloperDesc": "Write hamster params, materials, write-request bodies and TTS text to userData/radio-brief-debug.",
    "radioBriefSystemPrompt": "Brief prompt",
    "radioBriefSystemPromptDesc": "System prompt. The default is the programme-brief skill text. JSON output format is appended in the background.",
    "radioBriefSystemPromptReset": "Reset default",
    "radioBriefDuckLevel": "Music level while speaking",
    "radioBriefDuckRamp": "Duck ramp",
    "radioBriefUnduckRamp": "Unduck ramp",
    "radioBriefTavilyKey": "Tavily API key",
    "radioBriefMinimaxKey": "MiniMax API key",
    "radioBriefMinimaxVoice": "MiniMax voice ID",
    "radioBriefSaveKeys": "Save keys",
    "radioBriefProbe": "Check connectivity",
    "radioBriefProbeTavily": "Search",
    "radioBriefProbeMinimax": "Voice",
    "radioBriefProbeAi": "Copy",
    ...
    "playerControlSlotAction_radioBrief": "Radio brief",
  ...
  "player": {
    ...
    "radioBriefToggle": "Radio brief",
    "radioBriefGenerate": "Generate this brief",
    "radioBriefRegenerate": "Regenerate this brief",
  },
  "localMusic": {
