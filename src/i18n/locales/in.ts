...
export default {
  "notifications": {
    ...
    "radioBriefOn": "Siaran radio diaktifkan",
    "radioBriefOff": "Siaran radio dimatikan",
    "radioBriefPrefetchOn": "Prasiar brief radio diaktifkan",
    "radioBriefPrefetchOff": "Prasiar brief radio dimatikan",
    "radioBriefKeysSaved": "Kunci siaran radio disimpan",
    "radioBriefKeysSaveFailed": "Gagal menyimpan kunci siaran radio",
  ...
  "status": {
    ...
    "radioBriefLyrics": "Siaran: membaca lirik…",
    "radioBriefComments": "Siaran: mengambil komentar…",
    "radioBriefWeb": "Siaran: mencari latar belakang…",
    "radioBriefWriting": "Menulis brief siaran…",
    "radioBriefTts": "Siaran: mensintesis suara…",
    "radioBriefWaitingMix": "Siaran: menunggu titik masuk mix…",
    "radioBriefSpeaking": "Sedang siaran",
    "radioBriefDone": "Brief ini selesai",
    "radioBriefFailed": "Siaran gagal",
    "radioBriefMissingTavily": "Isi kunci Tavily di pengaturan siaran",
    "radioBriefMissingMinimax": "Isi kunci MiniMax di pengaturan siaran",
    "radioBriefNoComments": "Komentar panas tidak cukup",
    "radioBriefNoCommentsCapability": "Lagu ini tidak punya API komentar; pakai lagu NetEase",
    "radioBriefNoLyrics": "Lirik tidak cukup",
    "radioBriefNoWeb": "Pencarian web tidak memberi hasil",
    "radioBriefWebFailed": "Pencarian web gagal",
    "radioBriefTtsFailed": "Sintesis suara gagal",
    "radioBriefWriteFailed": "Penulisan brief gagal",
    "radioBriefNeedPlay": "Putar lagu dulu",
    "radioBriefNoAudioGraph": "Grafik audio belum siap; tekan putar dulu",
    "radioBriefDesktopOnly": "Sintesis brief hanya di desktop",
    "radioBriefProbeOk": "Konektivitas siaran normal",
    "radioBriefProbeFailed": "Pemeriksaan konektivitas siaran gagal",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "radio-brief-toggle": { "title": "Siaran radio", "description": "Buka pengaturan siaran radio: sakelar, prasiar, kunci Tavily dan MiniMax" },
      "radio-brief-prefetch-toggle": { "title": "Prasiar brief radio", "description": "Siapkan brief dan TTS untuk lagu antrean berikutnya" },
      "radio-brief-prefetch-count": { "title": "Jumlah prasiar brief radio", "description": "Buka pengaturan siaran untuk mengatur berapa lagu yang disiapkan" },
  ...
  "options": {
    ...
    "radioBriefSettings": "Siaran radio",
    "radioBriefEnable": "Aktifkan brief",
    "radioBriefEnableDesc": "Buat brief program untuk antrean putar, bicara setelah transisi selesai pada awal bagian lagu, dan turunkan musik di bawah TTS. Hanya desktop; butuh transisi Folia dan lagu NetEase.",
    "radioBriefDesktopOnly": "Sintesis brief hanya berjalan di aplikasi desktop.",
    "radioBriefPrefetch": "Siapkan lagu berikutnya",
    "radioBriefPrefetchDesc": "Saat lagu ini diputar, selesaikan lirik, komentar, pencarian web, naskah, dan TTS untuk lagu berikutnya.",
    "radioBriefPrefetchCount": "Jumlah lagu yang disiapkan",
    "radioBriefMix": "Duck musik saat siaran",
    "radioBriefVoiceLevel": "Volume siaran",
    "radioBriefDeveloper": "Mode pengembang",
    "radioBriefDeveloperDesc": "Tulis parameter hamster, bahan, body permintaan, dan teks TTS ke userData/radio-brief-debug.",
    "radioBriefSystemPrompt": "Prompt siaran",
    "radioBriefSystemPromptDesc": "Prompt sistem. Default-nya teks skill brief. Format keluaran JSON ditambahkan di latar belakang.",
    "radioBriefSystemPromptReset": "Kembali ke default",
    "radioBriefDuckLevel": "Volume musik saat berbicara",
    "radioBriefDuckRamp": "Waktu menurunkan",
    "radioBriefUnduckRamp": "Waktu menaikkan",
    "radioBriefTavilyKey": "Kunci API Tavily",
    "radioBriefMinimaxKey": "Kunci API MiniMax",
    "radioBriefMinimaxVoice": "ID suara MiniMax",
    "radioBriefSaveKeys": "Simpan kunci",
    "radioBriefProbe": "Periksa konektivitas",
    "radioBriefProbeTavily": "Pencarian",
    "radioBriefProbeMinimax": "Suara",
    "radioBriefProbeAi": "Naskah",
    ...
    "playerControlSlotAction_radioBrief": "Siaran radio",
  ...
  "player": {
    ...
    "radioBriefToggle": "Siaran radio",
    "radioBriefGenerate": "Buat brief lagu ini",
    "radioBriefRegenerate": "Buat ulang brief lagu ini"
  },
  "localMusic": {
