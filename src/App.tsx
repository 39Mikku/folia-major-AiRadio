...
import { useRadioBriefEngine } from './hooks/useRadioBriefEngine';
...
export default function App() {
    ...
    const { setupAudioAnalyzer, cacheSongAssets, cacheSongAssetsFor, adoptActiveDeckSource, getVoiceNodes } = usePlaybackAudioBridge({
        audioRef,
        localSongs,
        isLyricsLoading,
        shouldAutoPlayRef: shouldAutoPlay,
    ...
    useRadioBriefEngine({
        ...
        isBlendFading: automix.isBlendFading,
        getVoiceNodes,
    });
